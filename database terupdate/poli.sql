...
(4, 'safna', '$2y$10$vZx5627kGrW/Ce4VrPjzM.NmZqgF6kXMPrH6evCOaShIubqcZQ0dC'),
(5, 'khaidar29', '$2y$10$SHK8yTQcS.uMygMSUUVB7OY/CF3smbtOc1s2Th35qdTPryd9EH8X6');
...
(5, 'Yusiane', '$2y$10$Gnyxuw8GW.0bUNssBNHKYeJJ8TRdBjstVXsZzKZyo0QXih76GMi7.', 'pekalongan', '0875675675757', 3);
...
(15, 'Bodrex', 'tablet', 3000),
(16, 'Paramex', 'Botol', 200000),
(17, 'Paracetamol', 'Botol', 123000);
...
(4, 'Bovil', '', 'Pekalongan', '3326780866', '09877678657', '202305-03');
...
ALTER TABLE `daftar_poli`
  ...
  ADD CONSTRAINT `daftar_poli_ibfk_2` FOREIGN KEY (`id`) REFERENCES `periksa` (`id_daftar_poli`) ON DELETE CASCADE ON UPDATE CASCADE;
